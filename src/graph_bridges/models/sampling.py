...
if __name__=="__main__":
    from graph_bridges.tauLDR.config.train.graphs import get_config as get_train_config
    from graph_bridges.tauLDR.config.eval.graphs import get_config as get_eval_config
    ...
    model = GaussianTargetRateImageX0PredEMA(train_config,device)

    sampler = TauLeaping(eval_config)
    sample_results = sampler.sample(model, 10, 10)