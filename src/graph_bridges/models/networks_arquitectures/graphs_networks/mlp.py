...
from discrete_diffusion.models.graphs.cond_layers import ConditionalLayer1d
...
class MLP(nn.Module):
    def __init__(self, num_layers, input_dim, hidden_dim, output_dim, use_bn=False, activate_func=F.relu,
                 num_classes=None):
        """
            num_layers: number of layers in the neural networks_arquitectures (EXCLUDING the input layer). If num_layers=1, this reduces to linear model.
