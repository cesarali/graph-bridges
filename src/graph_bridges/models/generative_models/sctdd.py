...
from graph_bridges.models.losses.stdd_losses import CategoricalRationMatching
...
class SCTDD:
    ...
    loss: CategoricalRationMatching = None
    ...
    def create_new_from_config(self, config:CTDDConfig, device):
        ...
        self.loss = CategoricalRationMatching(config,device)
